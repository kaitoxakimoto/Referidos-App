...
class PromocionesMovilesPage extends StatefulWidget {
  const PromocionesMovilesPage({super.key});

  @override
  State<PromocionesMovilesPage> createState() => _PromocionesMovilesPageState();
}

class _PromocionesMovilesPageState extends State<PromocionesMovilesPage> {
  bool gotData = false;
  dynamic data = "";
  ...
  Future<void> llamadas() async {
    ...
    data = await httpRequest.getPromotionsMobile(userData["token"]);
    /*
